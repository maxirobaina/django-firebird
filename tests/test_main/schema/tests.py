...
class SchemaTests(TransactionTestCase):
    ...
    @isolate_apps("schema")
    @unittest.skipUnless(connection.vendor != "firebird", "Firebird specific")
    ...
    @skipUnlessDBFeature("supports_foreign_keys", "can_introspect_foreign_keys")
    @unittest.skipUnless(connection.vendor != "firebird",
                         'Firebird does not support updating a foreign key referencing itself')
    ...
    @isolate_apps("schema")
    @unittest.skipUnless(connection.vendor != 'firebird', 'Firebird does not support JSON field')
    ...
    def _test_m2m_create(self, M2MFieldClass):
        ...
        # Ensure there is now a m2m table there
    ...
    @isolate_apps("schema")
    def test_create_model_with_composite_index(self):
        """
        Tests creating models with a multi-column index in Meta.indexes
        """
        ...
        class TagIndexed(Model):
            ...
            class Meta:
                app_label = "schema"
                indexes = [Index(fields=["slug", "title"])]
